...
import AIChatbot, { type AIChatbotHandle } from '@/components/AIChatbot'
...
function RouteComponent() {
  ...
  const handleAskAI = useCallback((question: string) => {
    ...
    // Small delay so scroll completes before the chat fires
    setTimeout(() => chatRef.current?.askQuestion(question), 400)
  }, [])
